...
public class Fragment02_GvAdapter extends BaseAdapter {
	...
	public Fragment02_GvAdapter(FragmentActivity activity, int[] imgItemRes,
			String[] imgItemDesc) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if (convertView == null) {
			convertView = View.inflate(activity, R.layout.fragment02_gv, null);
		}
		image = (ImageView) convertView.findViewById(R.id.fragment02_gv_image);
		image.setImageResource(imgItemRes[position]);
		desc = (TextView) convertView.findViewById(R.id.fragment02_gv_desc);
